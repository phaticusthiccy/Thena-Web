(function () {
    ...
    const i18n = {
        en: {
            ...
            feat5Badge: 'AI Outpaint',
            feat5Title: 'Expand your <span class="text-gradient-purple">horizons.</span>',
            feat5Desc: 'Seamlessly extend any image beyond its original borders. Select specific directions, use intuitive size presets, and watch AI intelligently fill the canvas with perfectly matching context.',
            feat5Tag: 'AI Outpaint',
        ...
        tr: {
            ...
            feat5Badge: 'AI Outpaint',
            feat5Title: 'Ufkunuzu <span class="text-gradient-purple">genişletin.</span>',
            feat5Desc: 'Herhangi bir görüntüyü orijinal sınırlarının ötesine sorunsuzca genişletin. Belirli yönleri seçin, akıllı boyut ön ayarlarını kullanın ve yapay zekanın tuvali mükemmel uyumlu bağlamla doldurmasını izleyin.',
            feat5Tag: 'AI Outpaint',
