window.thenaUpdates = [
  {
    ...
    "version": "3.8.6",
    "title": {
      "en": "THENA PATCH NOTES v3.8.6",
      "tr": "THENA GÜNCELLEME NOTLARI v3.8.6"
    },
    "subtitle": {
      "en": "Nano Banana 2 Lite model release, high generation time alerts, and SSE stream API endpoints.",
      "tr": "Nano Banana 2 Lite modeli, yüksek görsel üretim süresi uyarıları ve SSE yayın akışlı API entegrasyonu."
    },
    "category": {
      "en": "Feature Release",
    ...
    "sections": [
      {
        ...
        "intro": {
          "en": "We are launching the ultra-fast Nano Banana 2 Lite model.",
          "tr": "Aşırı hızlı yeni Nano Banana 2 Lite modelini sunuyoruz."
        },
        "groups": [
          {
            "name": {
              "en": "Nano Banana 2 Lite",
              "tr": "Nano Banana 2 Lite Entegrasyonu"
            },
            "items": [
              {
                "en": "Integrated Google's Nano Banana 2 Lite, a lightweight and cost-effective image generation model optimized for high rendering speed.",
                "tr": "Google'ın hızlı görsel üretim ve düzenleme için optimize edilmiş, hafif ve uygun maliyetli Nano Banana 2 Lite modeli entegre edildi."
              }
            ]
          }
        ]
      ...
      {
        "title": {
          "en": "HIGH GENERATION TIME ALERT",
          "tr": "YÜKSEK ÜRETİM SÜRESİ UYARISI"
        },
        "intro": {
          "en": "Added pre-generation checks for heavy models with high processing times.",
          "tr": "Yüksek işlem süresine sahip ağır modeller için üretim öncesi kontrol mekanizması eklendi."
        },
        "groups": [
          {
            "name": {
              "en": "ETA Warnings",
              "tr": "Tahmini Süre Uyarısı"
            },
            "items": [
              {
                "en": "Introduced #eta-warning-modal to alert users if a selected model has a high estimated loading and generation time (> 80s).",
                "tr": "Seçilen modelin tahmini yükleme ve görsel oluşturma süresi 80 saniyeden fazla olduğunda kullanıcıyı uyaran #eta-warning-modal eklendi."
              },
              {
                "en": "Integrated Turkish and English translation files with new keys (etaWarningTitle, etaWarningDesc, btnContinue) and interactive confirm actions.",
                "tr": "Yeni dil anahtarlarıyla (etaWarningTitle, etaWarningDesc, btnContinue) etkileşimli onaylama butonlarının Türkçe ve İngilizce dil çevirileri sağlandı."
              }
            ]
          }
        ]
      ...
      {
        "title": {
          "en": "REAL-TIME STREAMING API ENDPOINT",
          "tr": "GERÇEK ZAMANLI AKIŞLI API ENTEGRASYONU"
        },
        "intro": {
          "en": "We added streaming progress details to the developer portal documentation.",
          "tr": "Geliştirici portali dökümanlarına gerçek zamanlı ilerleme akışı sağlayan endpoint dökümantasyonu eklendi."
        },
        "groups": [
          {
            "name": {
            ...
            "items": [
              {
                "en": "Documented the POST /createSyncPoll endpoint utilizing Server-Sent Events (SSE) for tracking image generation progress (e.g., 25%, 75%, 100%).",
                "tr": "Görsel üretme ilerlemesini (örn. %25, %75, %100) adım adım takip etmek için Server-Sent Events (SSE) teknolojisini kullanan POST /createSyncPoll dökümantasyonu eklendi."
              },
              {
                "en": "Fixed scroll jumping bugs on active code examples tabs for a cleaner api.html console UX.",
                "tr": "Daha akıcı bir konsol deneyimi sağlamak amacıyla aktif kod örneği sekmelerindeki kayma ve zıplama hataları giderildi."
              }
            ]
          }
        ]
  ...
  {
    "id": "v3.8.5-hotfix",
    "version": "3.8.5-hotfix",
    "title": {
      "en": "THENA PATCH NOTES v3.8.5-HOTFIX",
      "tr": "THENA GÜNCELLEME NOTLARI v3.8.5-HOTFIX"
    },
    "subtitle": {
      "en": "Initial language selection modal, welcome flow updates, and model catalog rendering optimizations.",
      "tr": "Başlangıç dil seçimi modalı, katılım akışı güncellemeleri ve model kataloğu render optimizasyonları."
    },
    "category": {
      "en": "Hotfix Release",
      "tr": "Hotfix Sürümü"
    ...
    "sections": [
      {
        "title": {
          "en": "INITIAL LANGUAGE SELECTION MODAL",
          "tr": "BAŞLANGIÇ DİL SEÇİM MODALI"
        },
        "intro": {
          "en": "Added a step for new users to choose their language before the intro begins.",
          "tr": "Yeni kullanıcıların sinematik tanıtım başlamadan önce dillerini seçebilmeleri için yeni bir adım eklendi."
        },
        "groups": [
          {
            "name": {
              "en": "Language Prompt",
              "tr": "Dil Tercih Penceresi"
            },
            "items": [
              {
                "en": "Introduced #tutorial-language-modal at the start of the onboarding flow to set preferred language (TR/EN) before welcome messages.",
                "tr": "Katılım akışının başlangıcına, karşılama mesajlarından önce Türkçe/İngilizce dil tercihini ayarlayan #tutorial-language-modal eklendi."
              },
              {
                "en": "Synchronized language selection to reload catalog translations, active character layouts, and settings options instantly.",
                "tr": "Dil tercihi seçildiğinde katalog çevirilerini, aktif karakter şablonlarını ve ayarlar panelini anında güncelleyecek şekilde senkronize edildi."
              }
            ]
          }
        ]
      ...
      {
        "title": {
          "en": "MODEL CATALOG PERFORMANCE OPTIMIZATIONS",
          "tr": "KATALOG PERFORMANS İYİLEŞTİRMELERİ"
        },
        "intro": {
          "en": "Optimized catalog rendering for smoother interactions.",
          "tr": "Daha akıcı katalog filtrelemeleri için render süreçleri optimize edildi."
        },
        "groups": [
          {
            "name": {
              "en": "Intersection Observer & Visibility",
              "tr": "Intersection Observer & Görünürlük Kontrolü"
            },
            "items": [
              {
                "en": "Implemented lazy IntersectionObserver tracking inside loadAllModels.js to manage card visibility and lifecycle efficiently.",
                "tr": "Kartların görünürlük ve yaşam döngülerini performanslı yönetmek için loadAllModels.js içine lazy IntersectionObserver takibi eklendi."
              },
              {
                "en": "Removed model-cards from visibilityOptimizer.js selectors list and increased mutation throttle to 500ms to reduce CPU usage.",
                "tr": "İşlemci yükünü azaltmak amacıyla model kartları visibilityOptimizer.js listesinden çıkarıldı ve mutasyon algılama gecikmesi 500ms'ye yükseltildi."
              }
            ]
          }
        ]
  ...
  },
  {
    ...
    "version": "3.8.4",
    "title": {
      "en": "THENA PATCH NOTES v3.8.4",
      "tr": "THENA GÜNCELLEME NOTLARI v3.8.4"
    },
    "subtitle": {
      "en": "My Shared Images portal, new API endpoints, and performance optimizations.",
      "tr": "Paylaştıklarım resim portali, yeni API uç noktası ve performans optimizasyonları."
    },
    "category": {
      "en": "Feature Release",
      "tr": "Özellik Güncellemesi"
    ...
    "sections": [
      {
        "title": {
          "en": "MY SHARED IMAGES PORTAL",
          "tr": "PAYLAŞTIKLARIM RESİM PORTALİ"
        },
        "intro": {
          "en": "Manage your shared public gallery creations directly from the workspace dashboard.",
          "tr": "Topluluk galerisinde paylaştığınız görselleri doğrudan kontrol panelinden yönetin."
        },
        "groups": [
          {
            "name": {
              "en": "User Gallery Shares",
              "tr": "Kullanıcı Paylaşımları"
            },
            "items": [
              {
                "en": "Added a dedicated 'My Shares' modal grid to view all your shared public showcase images.",
                "tr": "Topluluk galerisinde paylaştığınız tüm resimleri listelemek için özel 'Paylaştıklarım' ızgara arayüzü eklendi."
              },
              {
                "en": "Introduced a warning confirmation modal before uploading and sharing images to the public community feed.",
                "tr": "Görselleri topluluk akışına yükleyip paylaşmadan önce kullanıcıyı bilgilendiren onay kutusu eklendi."
              }
            ]
          }
        ]
      ...
      {
        "title": {
          "en": "DEVELOPER API EXPANSION",
          "tr": "API GELİŞTİRİCİ PORTALİ"
        },
        "intro": {
          "en": "We added new integration utilities for developer pipelines.",
          "tr": "Geliştiricilerin iş akışları için yeni entegrasyon araçları sunduk."
        },
        "groups": [
          {
            "name": {
              "en": "Shared Images Endpoint",
              "tr": "Paylaşılan Resimler Endpoint'i"
            },
            "items": [
              {
                "en": "Added GET /myPublicImages?key={key} API documentation to retrieve user's public image URLs.",
                "tr": "Kullanıcının paylaştığı resimlerin URL'lerini almak için GET /myPublicImages?key={key} API uç noktası dökümantasyonu eklendi."
              }
            ]
          }
        ]
      ...
      {
        "title": {
          "en": "PERFORMANCE & CPU OPTIMIZATIONS",
          "tr": "PERFORMANS & CPU OPTİMİZASYONLARI"
        },
        "intro": {
          "en": "Substantial engine refactoring to decrease CPU load and browser repaints.",
          "tr": "İşlemci yükünü ve tarayıcı çizimlerini azaltmak için kapsamlı altyapı iyileştirmeleri."
        },
        "groups": [
          {
            "name": {
              "en": "Animation & Rendering Control",
              "tr": "Animasyon & Çizim Kontrolü"
            },
            "items": [
              {
                "en": "Optimized visibilityOptimizer.js to dynamically pause animations of offscreen components using data-vo-paused attributes.",
                "tr": "Görünür ekranda yer almayan inaktif öğelerin animasyonlarını otomatik olarak durdurarak pil tasarrufu sağlayan visibilityOptimizer.js optimize edildi."
              },
              {
                "en": "Replaced synchronous layout thrashing with requestAnimationFrame for smoother model filter transitions.",
                "tr": "Daha akıcı model filtre geçişleri sağlamak amacıyla eşzamanlı sayfa düzeni tetiklemeleri requestAnimationFrame ile değiştirildi."
              }
            ]
          }
        ]
