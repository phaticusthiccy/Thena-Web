const translations = {
    "en": {
        ...
        "btnClose": "Close",
        "etaWarningTitle": "High Generation Time",
        "etaWarningDesc": "The selected model has a high estimated generation time (~{ETA}s). Starting this generation may take longer. Do you want to proceed?",
    ...
    "tr": {
        ...
        "btnClose": "Kapat",
        "etaWarningTitle": "Yüksek Üretim Süresi",
        "etaWarningDesc": "Seçilen modelin tahmini üretim süresi yüksektir (~{ETA}s). Bu üretimi başlatmak daha uzun sürebilir. Devam etmek istiyor musunuz?",
